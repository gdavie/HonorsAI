...
import core.IFitnessMeasure;
import core.MultiClassFitnessCase;
import core.RegisterCollection;


public class SRP_FitnessMeasure extends IFitnessMeasure {

	/** default cctor, dtor - no members*/
	public SRP_FitnessMeasure(){
		super();
	}
	
	public SRP_FitnessMeasure(SRP_FitnessMeasure mcfm){
		super(mcfm);
	}
	...
	public IFitnessMeasure clone() {
		...
		return new SRP_FitnessMeasure(this);
	}
