...
public abstract class IProgram<IPR extends IProgram<IPR>> {
	...
	public IProgram(IFitnessMeasure tfm, IFitnessMeasure vfm, int numFeatures, int numRegisters) {
	...
	public <X extends IProgram<X>>IProgram(IProgram<X> rhs) {
		trainFinalRegisterValues = new RegisterCollection(
